...
Cross reactivity of H3K4me3 and H3K9me3
...
prct_spikein_reads<-100000*colSums(data[,2:ncol(data)]) / (readstats$NReadsTrim * 2)

scale_factor<-as.matrix(prct_mouse_reads/prct_spikein_reads)
colnames(scale_factor)<-'scale factor'
